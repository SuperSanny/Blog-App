      ...
      <section className="relative bg-tertiary px-5">
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
            ...
            <p className="text-dark-hard text-sm leading-7 mt-6 md:text-center md:text-base lg:text-left">
              <span className="font-bold italic text-dark-hard md:not-italic md:font-normal md:text-dark-hard">
          ...
          <div className="col-span-12 hidden mb-[70px] md:block md:order-first lg:col-span-6 lg:order-last">
            <div className="w-3/4 mx-auto relative">
              ...
              <div className="w-1/2 h-1/2  bg-primary opacity-[0.1] rounded-lg absolute -bottom-[10%] -left-[8%]" />
              <div className="rounded-xl w-full bg-white p-3 z-[1] relative">
                ...
                />
                <div className="p-5">
                  <h2 className="font-bold text-xl text-dark-hard md:text-2xl lg:text-[28px]">
