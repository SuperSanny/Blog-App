...
const SuggestedPosts = ({ className, header, posts = [], tags }) => {
  return (
    ...
    >
        ...
        {posts.map((item) => (
          ...
          >
            <img
              ...
              alt="Laptop"
            />
            <div className="text-sm font-roboto text-primary font-medium">
              <h3 className="text-sm font-roboto text-primary font-medium md:text-base lg:text-lg">
                {item.title}
              </h3>
      ...
      <h2 className="font-roboto font-medium text-primary mt-8 md:text-xl">
        Tags
      </h2>
