    ...
    <li className="relative group">
      {item.type === "link" ? (
        ...
        <>
          ...
          <div className="hidden transition-all duration-500 pt-4 absolute bottom-0 right-0 trasnform translate-y-full group-hover:block w-max">
    ...
    <>
      <section>
        <header className="container mx-auto px-5 flex justify-between py-2 items-center">
          ...
          >
            <ul className=" text-white items-center gap-y-5 lg:text-secondary flex flex-col lg:flex-row  gap-x-2">
